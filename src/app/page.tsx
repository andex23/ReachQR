        ...
        <main className="min-h-screen flex flex-col">
            ...
            <div className="border-t border-border py-20 px-4">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-center md:text-left text-xl md:text-2xl font-mono font-medium text-ink mb-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-12 text-center md:text-left">
                        {/* WhatsApp Ready */}
                        <div>
                            <div className="w-16 h-16 bg-ink/5 rounded-2xl flex items-center justify-center mx-auto md:mx-0 mb-6">
